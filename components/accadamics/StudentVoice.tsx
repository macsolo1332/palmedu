...
const StudentVoice=()=>{
    ...
    <div className="relative bg-emerald-900 w-full h-[100%] justify-items-center ">
...
<img src="https://cdn.loyola.edu/project/core/extensions/institutional/home/images/amber-d-sm-min.jpg"
 ...
 className=" align-middle  justify-center rounded-full   w-[85%]  sm:mx-4 "  />
</div>
...
<div className=" mx-[5%]  text-[1.2rem] text-slate-50 tracking-tight subpixel-antialiased  mb-10">
    ...
    <div className="relative mx-[20%] w-[60%]">
